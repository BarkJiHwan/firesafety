...
public class TaewooriPoolManager : MonoBehaviourPunCallbacks
{
    ...
    /// <summary>
    /// 외부에서 씬 전환 시 호출할 메서드 - 인스턴스 없어도 호출 가능
    /// </summary>
